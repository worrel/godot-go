...
func (o *PlaneShape) setOwner(object *C.godot_object) {
	o.owner = object
}

func (o *PlaneShape) getOwner() *C.godot_object {
	return o.owner
}
...
func (o *PlaneShape) GetPlane() *Plane {
	...
	goRet := class.CallParentMethod(o, o.baseClass(), "get_plane", goArguments, "*Plane")
