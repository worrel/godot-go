...
import (
	...
	"github.com/shadowapex/godot-go/godot/classes/translation"
)
...
func (o *PHashTranslation) setOwner(object *C.godot_object) {
	o.owner = object
}

func (o *PHashTranslation) getOwner() *C.godot_object {
	return o.owner
}
