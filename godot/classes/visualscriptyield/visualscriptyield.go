...
func (o *VisualScriptYield) setOwner(object *C.godot_object) {
	o.owner = object
}

func (o *VisualScriptYield) getOwner() *C.godot_object {
	return o.owner
}
...
func (o *VisualScriptYield) GetYieldMode() int64 {
	...
	goRet := class.CallParentMethod(o, o.baseClass(), "get_yield_mode", goArguments, "int64")
